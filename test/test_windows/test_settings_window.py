...
def test_modify_general_save(mainwindow, monkeypatch, qtbot):
    ...
    assert split_types == ['The MARTe2 executable config file', 'The MARTe2 executable JSON file', 'The MARTe2 Python File'] # if you add supported files, you need to add it here also
...
def test_modify_remote_save(mainwindow, monkeypatch, qtbot):
    ...
    assert copy_settings == {'temp_folder': f'{home_dir}/.xmarte/', 'use_remote': False, 'remote_server': '127.0.0.1', 'remote_http_port': '1', 'remote_ftp_port': '2'}
...
def test_modify_remote_cancel(mainwindow, monkeypatch, qtbot):
    ...
    assert copy_settings == {'temp_folder': f'{home_dir}/.xmarte/', 'use_remote': False, 'remote_server': '127.0.0.1', 'remote_http_port': '8001', 'remote_ftp_port': '8234'}
...
def test_modify_compile_save(mainwindow, monkeypatch, qtbot):
    ...
    del copy_settings['ftp_username']
    del copy_settings['ftp_password']
    assert copy_settings == {'temp_folder': f'{home_dir}/.xmarte/compile', 'use_remote': False, 'remote_server': '127.30747.232987.237947',
...
def test_modify_compile_cancel(mainwindow, monkeypatch, qtbot):
    ...
    del copy_settings['ftp_username']
    del copy_settings['ftp_password']
    assert copy_settings == {'temp_folder': f'{home_dir}/.xmarte/compile', 'use_remote': False, 'remote_server': '127.0.0.1', 'remote_http_port': '8012',
...
def test_save_to_file(mainwindow, qtbot):
    ...
    assert data == {'CompilationPanel': {'remote_ftp_port': '2', 'remote_http_port': '1', 'remote_server': '127.30747.232987.237947',
                                         'static': False, 'temp_folder': f'{home_dir}/.xmarte/compile', 'use_remote': False},
                   ...
                   'RemotePanel': {'remote_ftp_port': '2', 'remote_http_port': '1', 'remote_server': '127.0.0.1', 'temp_folder': f'{home_dir}/.xmarte/',
                                   'use_remote': False}, 'TestPanel': {'Execution Rate (Hz)': '354', 'Max Cycles': '4658', 'solver': 'MARTe2'},
                  'gui': {'scene_height': 6400, 'scene_width': 6400}, 
                  'hidden': {'recovery_document': f'{home_dir}/.xmarte/recovery.xmt'}}
...
def test_cancel_to_file(mainwindow, qtbot):
    ...
    del data['RemotePanel']['ftp_password']
    del data['RemotePanel']['ftp_username']
    assert data == {'CompilationPanel': {'remote_ftp_port': '8235', 'remote_http_port': '8012', 'remote_server': '127.0.0.1', 'static': True, 'temp_folder': f'{home_dir}/.xmarte/compile', 'use_remote': False}, 
                   ...
                   'RemotePanel': {'remote_ftp_port': '8234', 'remote_http_port': '8001', 'remote_server': '127.0.0.1', 'temp_folder': f'{home_dir}/.xmarte/', 'use_remote': False}, 
